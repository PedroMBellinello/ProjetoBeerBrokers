...
@section('css')
   ...
   <link href="{{ asset('css/dadosPed.css') }}" rel="stylesheet">
  ...
  <section class="resumo">
    ...
    <div class="resumoCont">
      ...
      <div class="infoGeral">
        ...
        <p class="nPed" id="numero-pedido">51945184</p>
        {{-- <button class="btnEnviar">RASTREAR PEDIDO</button> --}}
        <p class="valor"><strong>Valor do pedido:</strong> <span id="valor-pedido">R$ 253,00</span></p>
        <p>Data de compra: <span id="data-compra">15/04/2022</span></p>
        <p>Forma de pagamento: <span id="forma-pagamento">Cartão</span></p>
        <p>Pagamento: <span id="pagamento">à vista</span></p>
        <p>Status: <span id="status">Faturado</span></p>  
      </div>
    ...
    <div class="resumoCont">
      ...
      <div class="boxCerv">
        <div class="infoGeral">
          <p><strong>CNPJ:</strong> <span id="cnpj"> Teste </span></p>
          <p><strong>Razão Social:</strong> <span id="razaoSocial"> Teste </span></p>
          <p><strong>Nome Fantasia:</strong> <span id="nomeFantasia"> Teste </span></p>
          <p><strong>Inscrição Estadual:</strong> <span id="inscricaoEstadual"> Teste </span></p>
          <p><strong>Inscrição Municipal:</strong> <span id="inscricaoMunicipal"> Teste </span></p>
          <p><strong>E-mail:</strong> <span id="email"></span> Teste </p>
          <p><strong>Telefone:</strong> <span id="telefone"></span> Teste </p>
        </div>
      </div>
    </div>
    <div class="resumoCont">
      ...
      <div class="boxCerv">
        <div class="infoGeral">
          <p><strong>Endereço entrega:</strong> <span id="endereco-entrega"> Teste </span></p>
          <p><strong>Logradouro:</strong> <span id="logradouro"> Teste </span></p>
          <p><strong>Número:</strong> <span id="numero"> Teste </span></p>
          <p><strong>Bairro:</strong> <span id="bairro"> Teste </span></p>
          <p><strong>CEP:</strong> <span id="cep"> Teste </span></p>
          <p><strong>Cidade:</strong> <span id="cidade"> Teste </span></p>
          <p><strong>Estado:</strong> <span id="estado"> Teste </span></p>
          <p><strong>Complemento:</strong> <span id="complemento"> Teste </span></p>
          <p><strong>Nome do responsável:</strong><br> <span id="nome-responsavel"> Teste </span></p>
          <p><strong>E-mail do responsável:</strong><br> <span id="email-responsavel"> Teste </span></p>
          <p><strong>Telefone do responsável:</strong><br> <span id="telefone-responsavel"> Teste </span></p>
        </div>
      </div>
    </div>
  </section>
